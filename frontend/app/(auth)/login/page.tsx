  ...
  return (
    <>
      ...
      <div className="flex min-h-screen" style={{ minHeight: '100dvh' }}>
          ...
          <div className="w-full max-w-[380px] mx-auto lg:max-w-none">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full rounded-xl py-3 mt-2 min-h-[48px] bg-[#3064E8] hover:bg-blue-700 text-white font-semibold text-sm active:scale-95 transition-all duration-150 disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100"
              >
        ...
        <div
          className="hidden lg:flex flex-col flex-1 relative overflow-hidden min-h-screen"
          style={{ background: 'linear-gradient(135deg, #0a0a1a 0%, #0d1b4b 30%, #1a3a8f 60%, #2952c8 100%)' }}
        >
          {/* Blob 1 */}
          <div
            style={{
              ...
              left: '-100px',
              borderRadius: '50%',
              background: 'radial-gradient(circle, #4a7eff88, transparent)',
          ...
          <div
            style={{
              ...
              right: '-80px',
              borderRadius: '50%',
              background: 'radial-gradient(circle, #1a4fd688, transparent)',
          ...
          >
           ...
           <p className="text-white/80 mt-2 text-2xl font-semibold max-w-md  mx-auto">Streamline your workflow, boost productivity.</p>
           <ul className='my-10 text-left max-w-xs mx-auto list-disc list-inside'>
            <li className="text-white/80 mt-1 text-sm">Manage tasks effortlessly</li>
           <li className="text-white/80 mt-1 text-sm">Your all-in-one task management solution.</li>
            <li className="text-white/80 mt-1 text-sm">Manage tasks effortlessly, stay organized.</li>
           <li className="text-white/80 mt-1 text-sm">Your task management solution.</li>
           </ul>




           <p className="text-white/80 mt-4 text-xs italic">“The best way to get something done is to begin.” – <a href="https://www.goodreads.com/quotes/161-the-best-way-to-get-something-done-is-to-begin" target="_blank" className="underline">Unknown</a></p>
          </div>
        </div>
